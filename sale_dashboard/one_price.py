...
{status_html}
      ...
      <div class="room-controls">
        ...
        <div class="floor-toolbar" aria-label="楼层分布缩放控制" hidden>
          ...
          <button type="button" data-role="reset-zoom">复位</button><button type="button" data-role="floor-fullscreen" aria-pressed="false">全屏地图</button>
